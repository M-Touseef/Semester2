...
void createQuestions(char questions[][100], char choices[][4][50], char answers[]) {
...
void takeQuiz(char questions[][100], char choices[][4][50], char answers[], char studentAnswers[][NUM_QUESTIONS], int studentIDs[]) {
    cout << "\n--- Quiz ---" << endl;
...
int main() {
    ...
    char choices[NUM_QUESTIONS][4][50];
